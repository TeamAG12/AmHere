...
config = {
    "apiKey": "AIzaSyBst9AMBB-ljQTAV5Bkle5KMapKobhRjwo",
    "authDomain": "amhere-bafeb.firebaseapp.com",
    "databaseURL": "https://amhere-bafeb-default-rtdb.europe-west1.firebasedatabase.app",
    "projectId": "amhere-bafeb",
    "storageBucket": "amhere-bafeb.appspot.com",
    "messagingSenderId": "335508449192",
    "appId": "1:335508449192:web:ab6794b9d147fead279f9d"
}

firebase = firebase.FirebaseApplication("https://amhere-bafeb-default-rtdb.europe-west1.firebasedatabase.app", None)
blob = Blob.from_string("gs://amhere-bafeb.appspot.com/uploads")
...
def trackImages():
    ...
    data =  { 'name': "Date_"+date+"  Time_"+Hour+"-"+Minute+"-"+Second, 'url': "https://firebasestorage.googleapis.com/v0/b/gs://amhere-bafeb.appspot.com/uploads %2FAttendance%5CAttendance_"+date+"_"+Hour+"-"+Minute+".csv?alt=media&token="+blob['downloadTokens']}
...
lbl3 = tk.Label(window, text="DESIGN BY AG12", width=80, fg="white", bg="black", font=('times', 15, ' bold')) 
